import 'package:app_magic_market_mobile/Views/Articles/articlesUser.dart';
...
class _EditArticlePage extends State<EditArticlePage> {
  ...
  void updateArticle() async {
    final response = await http.put(Uri.parse('$API_URI_CASA/updateArticle'),
  ...
  void deleteArticle() async {
    ...
    final response = await http
        .delete(Uri.parse('$API_URI_CASA/deleteArticle?idArticle=$idArticle'));
