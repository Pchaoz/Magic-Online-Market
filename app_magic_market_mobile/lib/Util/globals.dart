...
String API_URI_CASA = 'http://192.168.0.14:8000/api';
...
Future<List<dynamic>> fetchUserInfo() async {
  ...
  print("REQUEST A -> $API_URI_CASA/getUser/$userID");
  final response = await http.get(Uri.parse("$API_URI_CASA/getUser/$userID"));
